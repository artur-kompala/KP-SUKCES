  ...
  return (
    <li key={person.id} className="flex justify-start gap-x-6 py-5 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
          <div className="flex min-w-0 gap-x-4">
            <img alt={`Photo of person ${person.fullName}`} src={person.photoSrc ? person.photoSrc : "public/default-profile.jpg"} className="h-12 w-12 flex-none rounded-full bg-gray-50" />
