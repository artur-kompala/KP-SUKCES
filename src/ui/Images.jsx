...
const filters = [
  ...
  },
  {
    ...
    name: 'Miasto',
    options: [
      { value: 'Gliwice', label: 'Gliwice', checked: false },
      { value: 'Dobrodzień', label: 'Dobrodzień', checked: false },
      { value: 'Giżycko', label: 'Giżycko', checked: false },
      { value: 'Pawłowice', label: 'Pawłowice', checked: false },
      { value: 'Dębica', label: 'Dębica', checked: false },
      { value: 'Oleśnica', label: 'Oleśnica', checked: false },
      { value: 'Knurów', label: 'Knurów', checked: false },
      { value: 'Mława', label: 'Mława', checked: false },
      { value: 'Kędzierzyn-Koźle', label: 'Kędzierzyn-Koźle', checked: false },
      { value: 'Radlin', label: 'Radlin', checked: false },
      { value: 'Nowa Ruda', label: 'Nowa Ruda', checked: false },
      { value: 'Tychy', label: 'Tychy', checked: false },
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Galeria zdjęć</h1>
